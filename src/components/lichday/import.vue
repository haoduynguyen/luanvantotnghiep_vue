                ...
                <v-form id="formData" v-model="valid" v-on:submit.prevent="importExcel" method="POST">
                    <v-card-text>
                        ...
                        <div class="file-upload">
                            ...
                            <v-btn class="btn-image"><img id="blah" alt="your image" style="width: 100%"
                                                          v-bind:src="image"/></v-btn>
                            <p style="text-align: center; margin-top: 10px">Up file excel tại đây với đuôi file
                                .xlsx</p>
                        </div>
                    ...
                    <v-card-actions>
                        <v-btn :disabled="info != '' ? true : false" v-bind:to="{name: 'LichDay'}">Trở về</v-btn>
                        <v-spacer></v-spacer>
                        <v-btn :disabled="info != '' ? true : false" type="submit" class="btn btn-xs btn-primary" color="success">Lưu</v-btn>
                    </v-card-actions>
                </v-form>
                <v-progress-circular
                        v-if="info != ''"
